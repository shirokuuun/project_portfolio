      ...
      <div className="max-w-3xl mx-auto px-4">
        ...
        <div className="rounded-xl p-8 border-white/10 border hover:-translate-y-1 transition-all">
          <p className="text-gray-300 mb-6">
            Motivated developer to apply expertise in software development, app
            development, and cloud engineering, contribute innovative solutions
            to real-world challenges, and gain hands-on experience that sharpens
          ...
          <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
            ...
            <div className="space-y-4 text-gray-300 ">
              <div>
                ...
                <p>
                  Assisted in developing an Alumni Website and performed quality
                  assurance testing to ensure functionality and user experience
                  to Makati Waste.
                </p>
              </div>
            </div>
